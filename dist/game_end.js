...
class GameEnd extends Phaser.Scene {
    ...
    init (data) {
        ...
        this.redusername = "red";
        this.blueusername = "blue";
    ...
    create() {
        ...
        socket.on("getnames", (data) => {
            this.redusername = data.cat1name;
            this.blueusername = data.cat2name;


            if (this.redCatScore>this.blueCatScore) {
                const redCatName = this.add.text(65, 140, this.redusername, {
                    fontSize: 18,
                    fontStyle: 'bold',
                    color: '#F9E83E'
                });
                ...
                const blueCatName = this.add.text(660, 140, this.blueusername, {
                    fontSize: 18,
                    color: '#ffffff'
                });
            }
                ...
                const blueCatName = this.add.text(670, 140, this.blueusername, {
                    fontSize: 18,
                    fontStyle: 'bold',
                    color: '#F9E83E'
                });
            ...
            var winner;
        if (this.redCatScore>this.blueCatScore) winner = this.redusername
        else winner = this.blueusername
